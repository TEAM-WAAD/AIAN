...
io.popen("cd library && wget https://raw.githubusercontent.com/TEAM-WAAD/AIAN/main/library/redis.lua") 
...
function usergp(User)
local var = "لايوجد"
local url , res = https.request("https://api.telegram.org/bot"..token.."/getchat?chat_id="..User)
data = json:decode(url)
if data.result.photo.big_file_id then
var = data.result.photo.big_file_id
end
return var
end
...
--------------------------------------------------------------------------------------------------------------
function SourceWAAD(msg,data) -- بداية العمل 
if msg then
...
bnnaGet(msg.sender_user_id_, VvTVv2_name)
end
...
if database:get(bot_id.."VvTVv2:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'VvTVv2:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *✺│لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'nnnnBn')..')'
status  = '\n*✺│تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *✺│اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✺│العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'nnnnBn')..')'
...
local TexWAD = {string.match(text, "^(كتم) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexWAD[3] == 'يوم' then
Time_Restrict = TexWAD[2]:match('(%d+)')
Time = Time_Restrict * 86400
end
if TexWAD[3] == 'ساعه' then
Time_Restrict = TexWAD[2]:match('(%d+)')
Time = Time_Restrict * 3600
end
if TexWAD[3] == 'دقيقه' then
Time_Restrict = TexWAD[2]:match('(%d+)')
Time = Time_Restrict * 60
end
TexWAD[3] = TexWAD[3]:gsub('دقيقه',"دقايق") 
TexWAD[3] = TexWAD[3]:gsub('ساعه',"ساعات") 
TexWAD[3] = TexWAD[3]:gsub("يوم","ايام") 
if WAADSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✺│لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = TexWAD[4]}, start_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
local TexWAD = {string.match(text, "^(تقيد) (%d+) (.*)$")}
function start_function(extra, result, success)
if TexWAD[3] == 'يوم' then
Time_Restrict = TexWAD[2]:match('(%d+)')
Time = Time_Restrict * 86400
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *✺│اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'nnnnBn')..')'
status  = '\n*✺│تم تقيده لمدة ~* { '..TexWAD[2]..' '..TexWAD[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
local msg_id = msg.id_/2097152/0.5keyboard = {} 
keyboard.inline_keyboard = {{{text = 'ي ',url="t.me/nnnnbn"}}}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/'..photogp..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..token..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if linkgpp.ok == true then 
...
database:set(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✺│ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."WAAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."WAAD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✺│تم منع الكلمه مع التحذير*")  
database:del(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."WAAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."WAAD1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."WAAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✺│ارسل الكلمه الان*")  
database:set(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."WAAD1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."WAAD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."WAAD1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."WAAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."WAAD1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."WAAD1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevWAADW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✺│تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevWAADW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *✺│اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'nnnnBn')..')'..'\n*✺│تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevWAADW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevWAADW(msg) then  
...
if not database:get(bot_id..'VvTVv2:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'VvTVv2:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."VvTVv2:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and Manager(msg) then  
local list = database:smembers(bot_id.."VvTVv2:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "*✺│تم مسح "..k.." من الوسائط الموجوده*"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."VvTVv2:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."VvTVv2:allM"..msg.chat_id_)
...
if database:get(bot_id..'Bc:Bots') and not DevWAADW(msg) then 
...
if WAADSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevWAADW(msg) then 
...
if text == ("ردود المطور") and DevWAADW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✺│قائمة ردود المطور \n*◐•━━━━━━ 𝗪𝗔 ━━━━━━━•◐*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevWAADW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevWAADW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevWAADW(msg) then   
...
if text == 'تعطيل المغادره' and DevWAADW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'nnnnBn')..')'
local iduser = result.sender_user_id_
...
if text == 'استعاده الاوامر' and DevWAADW(msg) then
...
{{text = '𓅛 ＷＡＡＤ ＴＥＡＭ', url="t.me/nnnnBn"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𓅛 ＷＡＡＤ ＴＥＡＭ', url="t.me/nnnnBn"}},
{{text = 'مطـور السـورس', url="t.me/VvTVv2"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⍆ ＷＡＡＤ ＴＥＡＭ',url="t.me/nnnnBn"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = '𓅛 sᴏᴜʀᴄᴇ ᴡᴀᴀᴅ',url='http://t.me/nnnnBn'}},
}
